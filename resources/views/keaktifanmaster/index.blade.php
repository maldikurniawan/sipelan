...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a href="#" class="btn btn-primary" id="tambahkeaktifanmaster">
                            ...
                            <div class="row mt-2">
                                <div class="col-12">
                                    <form action="/keaktifanmaster" method="GET">
                                        <div class="row">
                                            <div class="col-4">
                            ...
                            <div class="row mt-2">
                                <div class="col-12">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            @foreach ($keaktifanmaster as $d)
                                                <tr>
                                                    <td>{{ $loop->iteration + $keaktifanmaster->firstItem() - 1 }}</td>
                                                    <td>{{ $d->nama_matkul }}</td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <form action="/keaktifanmaster/{{ $d->id }}/delete"
                                    ...
                                    {{ $keaktifanmaster->links('vendor.pagination.bootstrap-5') }}
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    {{-- Modal Store --}}
    <div class="modal modal-blur fade" id="modal-inputkeaktifanmaster" tabindex="-1" role="dialog"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Data Keaktifan</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="/keaktifanmaster/store" method="POST" id="frmsiswa" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
    ...
    {{-- Modal Edit --}}
    <div class="modal modal-blur fade" id="modal-editkeaktifanmaster" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Data Keaktifan</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
...
@push('myscript')
    <script>
        $(function() {
            $("#tambahkeaktifanmaster").click(function() {
                $("#modal-inputkeaktifanmaster").modal("show");
            });
            ...
            $(".edit").click(function() {
                ...
                $("#modal-editkeaktifanmaster").modal("show");
            });
