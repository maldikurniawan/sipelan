<form action="/mahasiswa/{{ $mahasiswa->id }}/update" method="POST" id="frmmahasiswa" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $mahasiswa->npm }}" id="npm" name="npm" class="form-control"
                    placeholder="NPM">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $mahasiswa->name }}" id="name" name="name" class="form-control"
        ...
        <div class="col-12">
            <select name="angkatan_id" id="angkatan_id" class="form-select">
                ...
                @foreach ($angkatan as $d)
                    <option {{ $mahasiswa->angkatan_id == $d->angkatan_id ? 'selected' : '' }}
