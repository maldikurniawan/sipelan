<form action="/absensimaster/{{ $absensimaster->id }}/update" method="POST" id="frmabsensimaster"
    ...
    <div class="row">
        <div class="col-12">
            <select name="matkul_id" id="matkul_id" class="form-select">
                ...
                @foreach ($matkul as $d)
                    <option {{ $absensimaster->matkul_id == $d->id ? 'selected' : '' }} value="{{ $d->id }}">
                        {{ $d->nama_matkul }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="col-12">
            <select name="pertemuan_id" id="pertemuan_id" class="form-select">
                ...
                @foreach ($pertemuan as $d)
                    <option {{ $absensimaster->pertemuan_id == $d->id ? 'selected' : '' }} value="{{ $d->id }}">
                        {{ $d->nama_pertemuan }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="col-12">
            <select name="mahasiswa_id" id="mahasiswa_id" class="form-select">
                ...
                @foreach ($mahasiswa as $d)
                    <option {{ $absensimaster->mahasiswa_id == $d->id ? 'selected' : '' }} value="{{ $d->id }}">
                        {{ $d->name }}
                    </option>
                @endforeach
            </select>
    ...
    <div class="row mt-3">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $absensimaster->status }}" id="status" name="status"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="time" value="{{ $absensimaster->jam_masuk }}" id="jam_masuk" name="jam_masuk"
