...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a href="#" class="btn btn-primary" id="tambahabsensimaster">
                            ...
                            <div class="row mt-2">
                                <div class="col-12">
                                    <form action="/absensimaster" method="GET">
                                        <div class="row">
                                            <div class="col-4">
                            ...
                            <div class="row mt-2">
                                <div class="col-12">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            @foreach ($absensimaster as $d)
                                                ...
                                                @endphp
                                                <tr>
                                                    <td>{{ $loop->iteration + $absensimaster->firstItem() - 1 }}</td>
                                                    <td>{{ $d->nama_matkul }}</td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <form action="/absensimaster/{{ $d->id }}/delete"
                                    ...
                                    {{ $absensimaster->links('vendor.pagination.bootstrap-5') }}
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    {{-- Modal Store --}}
    <div class="modal modal-blur fade" id="modal-inputabsensimaster" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/absensimaster/store" method="POST" id="frmsiswa" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="time" value="" id="jam_masuk" name="jam_masuk"
    ...
    {{-- Modal Edit --}}
    <div class="modal modal-blur fade" id="modal-editabsensimaster" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
...
@push('myscript')
    <script>
        $(function() {
            $("#tambahabsensimaster").click(function() {
                $("#modal-inputabsensimaster").modal("show");
            });
            ...
            $(".edit").click(function() {
                ...
                $("#modal-editabsensimaster").modal("show");
            });
