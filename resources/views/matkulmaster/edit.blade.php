<form action="/matkulmaster/{{ $matkulmaster->id }}/update" method="POST" id="frmmatkulmaster" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $matkulmaster->nama_matkul }}" id="nama_matkul" name="nama_matkul"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $matkulmaster->hari_matkul }}" id="hari_matkul" name="hari_matkul"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="time" value="{{ $matkulmaster->jam_matkul }}" id="jam_matkul" name="jam_matkul"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $matkulmaster->lokasi_matkul }}" id="lokasi_matkul" name="lokasi_matkul"
