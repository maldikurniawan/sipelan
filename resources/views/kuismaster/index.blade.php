...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a href="#" class="btn btn-primary" id="tambahkuismaster">
                            ...
                            <div class="row mt-2">
                                <div class="col-12">
                                    <form action="/kuismaster" method="GET">
                                        <div class="row">
                                            <div class="col-4">
                            ...
                            <div class="row mt-2">
                                <div class="col-12">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            @foreach ($kuismaster as $d)
                                                <tr>
                                                    <td>{{ $loop->iteration + $kuismaster->firstItem() - 1 }}</td>
                                                    <td>{{ $d->nama_matkul }}</td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <form action="/kuismaster/{{ $d->id }}/delete"
                                    ...
                                    {{ $kuismaster->links('vendor.pagination.bootstrap-5') }}
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    {{-- Modal Store --}}
    <div class="modal modal-blur fade" id="modal-inputkuismaster" tabindex="-1" role="dialog"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Data Kuis</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="/kuismaster/store" method="POST" id="frmsiswa" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
    ...
    {{-- Modal Edit --}}
    <div class="modal modal-blur fade" id="modal-editkuismaster" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Data Kuis</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
...
@push('myscript')
    <script>
        $(function() {
            $("#tambahkuismaster").click(function() {
                $("#modal-inputkuismaster").modal("show");
            });
            ...
            $(".edit").click(function() {
                ...
                $("#modal-editkuismaster").modal("show");
            });
